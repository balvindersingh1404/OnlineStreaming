...
public class SurveySignupActivity extends AppCompatActivity {
    ...
    private void initializeActivity() {
        ...
        ll_silding.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mm = new Intent(mContext, SelectCategoryActivity.class);
                mm.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(mm);
                SurveySignupActivity.this.finish();            }
        });
    ...
    public void answeareQuestion(String query) {
        ...
        APIHandler.Instance().POST_BY_AUTHEN("survey/submit", param, new APIHandler.RequestComplete() {
            ...
            public void onRequestComplete(final int code, final String response) {
                SurveySignupActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
