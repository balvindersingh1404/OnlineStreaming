...
import com.headsupseven.corp.WebViewActivity;
...
public class Headsup7Adapter extends RecyclerView
        .Adapter<Headsup7Adapter
        .DataObjectHolder> {
    ...
    public Headsup7Adapter(Context context, Vector<HomeLsitModel> myDataset) {
        mContext = context;
        mDataset = myDataset;
    }
                    ...
                    public void onClick(View view) {
                        ...
                        try {
                            ...
                            if (homeLsitModel.getPostType().equalsIgnoreCase("news")) {
                                ...
                                webViewIntent.putExtra("Url", homeLsitModel.getVideoName());
