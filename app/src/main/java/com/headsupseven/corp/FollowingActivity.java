...
import com.headsupseven.corp.adapter.FollowingAdapter;
...
public class FollowingActivity extends AppCompatActivity {
    ...
    public void initUI() {
        ...
        mFollowingAdapter = new FollowingAdapter(mContext, allFriendModel);
        ...
        listView_follow.setAdapter(mFollowingAdapter);
    ...
    private void loadMoreData(int page) {
        ...
        APIHandler.Instance().POST_BY_AUTHEN("user/app/" + user_id + "/get-following", param, new APIHandler.RequestComplete() {
            @Override
    ...
    public void responseDataShow(final String response) {
        try {
            ...
            for (int index = 0; index < json.length(); index++) {
                ...
                mFollowingAdapter.addnewItem(mFriendModel);
