...
public class LineView extends View {
    ...
    public LineView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textColor = ta.getColor(R.styleable.LineView_textColor_line, ContextCompat.getColor(getContext(), R.color.black));
        lineColor = ta.getColor(R.styleable.LineView_lineColor_line, ContextCompat.getColor(getContext(), R.color.colorAccent));
        lineWidth = ta.getDimension(R.styleable.LineView_lineWidth_line, 3);
        dotRadius = ta.getDimension(R.styleable.LineView_dotRadius_line, 10);
        dataFactor = ta.getInteger(R.styleable.LineView_dataFactor_line, 100);
        ...
        dashColor = ta.getColor(R.styleable.LineView_dashColor_line, ContextCompat.getColor(getContext(), R.color.colorPrimary));
