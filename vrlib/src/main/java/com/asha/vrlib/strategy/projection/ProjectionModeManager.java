 ...
 */
public class ProjectionModeManager extends ModeManager implements IProjectionMode {
    ...
    public ProjectionModeManager(int mode, MDGLHandler handler, Params projectionManagerParams) {
        super(mode, handler);
        this.mStrategyType = "AbsProjectionStrategy";
    ...
    public MDAbsPlugin getMainPlugin() {
        if (mMainPlugin == null){
            mMainPlugin = getStrategyProjection().buildMainPlugin(mMainPluginBuilder);
        }
        return mMainPlugin;
    }
    ...
    public void on(Activity activity) {
        ...
        MD360DirectorFactory factory = getStrategyProjection().hijackDirectorFactory();
    ...
    protected AbsProjectionStrategy createStrategyProjection(int mode) {
    ...
    public MDPosition getModelPosition() {
        return getStrategyProjection().getModelPosition();
    }

    @Override
    public MDAbsObject3D getObject3D() {
        return getStrategyProjection().getObject3D();
    }
